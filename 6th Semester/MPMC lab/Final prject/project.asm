...
.data
    ...
    invalid_msg db 13, 10, 'Invalid input. Please give your choice again.', 13, 10, '$'
    num1 dw 0
    num2 dw 0
    result dw 0
    choice db 0
...
; Get two 2-digit numbers on separate lines
...
; Check if addition result is within limit (999)
...
; Check if multiplication result is within limit (9999)
...
; Display result with minus sign if negative
display_result proc
